...
# 从预训练模型加载分词器和模型
tokenizer = BertTokenizer.from_pretrained('/Users/jin/.cache/modelscope/hub/models/google-bert/bert-base-chinese')
model = BertForSequenceClassification.from_pretrained('/Users/jin/.cache/modelscope/hub/models/google-bert/bert-base-chinese', num_labels=17)
