...
client = openai.OpenAI(
    api_key="sk-f9bac974cf79404691f92e06f567ea27", # https://bailian.console.aliyun.com/?tab=model#/api-key
...
class Translate(BaseModel):
    ...
    destination_language: str = Field(description="目标语言")
    conent: str = Field(description="待翻译文本")
result = ExtractionAgent(model_name = "qwen-plus").call('帮我把 good! 翻译成中文', Translate)
print(result)
